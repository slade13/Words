...
p1 = Package.create(name: 'Colors', description: 'Learn colors in easy way!', category: c1);

Word.create(english_name: 'red', polish_name: 'czerwony', package: p1);
Word.create(english_name: 'green', polish_name: 'zielony', package: p1);
Word.create(english_name: 'blue', polish_name: 'niebieski', package: p1);
Word.create(english_name: 'cyan', polish_name: 'akwamarynowy', package: p1);
Word.create(english_name: 'yellow', polish_name: 'żółty', package: p1);
Word.create(english_name: 'pink', polish_name: 'różowy', package: p1);
Word.create(english_name: 'black', polish_name: 'czarny', package: p1);
Word.create(english_name: 'white', polish_name: 'biały', package: p1);
Word.create(english_name: 'silver', polish_name: 'srebrny', package: p1);

p2 = Package.create(name: 'Home', description: 'Types of buildings and furnitures', category: c1);
